...
(function () {
  ...
  const EN = {
    ...
    "exp.mwdEval": "I compared predicted hazard zones against RMR-decline zones in 0.5 m depth bins, computing Precision, Recall, F1, Accuracy and OMC. This identified stable feature combinations and models per site.",
    ...
    "proj.n2sP1": "Designed an AI news collection flow on GitHub Actions with local LLM agent processing",
    "proj.n2sP2": "Added a human-in-the-loop approval step to control absorption into the knowledge base",
    "proj.n2sP3": "Managed output trust via static audit, HMAC provenance and downgrade prevention",
    "proj.n2sScopeH": "Scope",
    "proj.n2sScope": "Designed a knowledge pipeline where GitHub Actions collects AI news candidates and a local LLM workflow handles draft generation, approval and commit.",
    "proj.n2sTrustH": "Trust mechanisms",
    "proj.n2sTrust": "Output signing, static audit and downgrade-prevention checks ensure automated results pass verification before being applied.",
    ...
    "proj.kraftonP2": "Separated contest submissions from post-contest improvements to record changes and limits",
    "proj.kraftonP3": "Analyzed problem intent, structure and improvement directions based on organizer notes",
    "proj.kraftonOrgH": "How it is organized",
    "proj.kraftonOrg": "Prelim Day 1·2 and finals Day 1·2 problems are split into contest submissions and just-after-contest improvements, recording the solving flow and limitations.",
    "proj.kraftonRepH": "Representative problems",
    "proj.kraftonRep": "VideoAgent is organized as a video-split, frame-extraction and summary-merge flow; BattlePredict records a Bradley-Terry and Hungarian-matching approach.",
    ...
    "collab.busanDesc": "A Busan fishing-info service planned and built with a team at the Busan Ralphton hackathon hosted by the Codex community. It won the Host Voting Award and is being actively improved toward an actual product launch.",
    "collab.busanP1": "Joined a team across service planning and development",
    "collab.busanP2": "Won the hackathon's Host Voting Award",
    "collab.busanP3": "Improving features toward a real service launch after the contest",

    "collab.mapleType": "Hackathon Team Portfolio",
    "collab.mapleDesc": "A team portfolio website built with Microsoft AI School graduates to apply for the 2026 Maker-thon. It presents members' technical experience and project history through a character-select interface.",
    "collab.mapleScopeH": "My role",
    "collab.mapleScope": "For this Maker-thon team portfolio I organized each member's character concept and visual direction and took part in producing the character design assets, weaving the graduates' project history and personality into a character-select screen.",
    "collab.mapleEvidence": "Deliverables: member character images and a MapleStory-flavored portfolio visual concept.",
